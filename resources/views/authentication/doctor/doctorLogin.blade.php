...
@section('main')
    <div class="flex items-center w-full h-full p-12 gap-x-4">
        <div
            ...
            <div class="px-24 py-4 mt-12 space-y-4 ">
                <div class="mb-11">
                    ...
                    <a href="{{route('doctorSignupView')}}">Sign in</a>
                </div>

                <form class="space-y-1 md:space-y-6 w-96" method="post" action="{{ route('doctorAuthenticate') }}">
                    @csrf
                    <div class="mb-6">
                        <label for="email"
        ...
        <div class="w-1/2 h-full bg-black rounded-md ">
            <img class="object-cover w-full h-full rounded-md shadow-lg" src="{{ asset('assets/img/benefits5.jpg') }}"
                alt="" />
        </div>
    </div>
@endsection
