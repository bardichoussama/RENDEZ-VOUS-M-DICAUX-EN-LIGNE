...
@section('main')
    ...
    <div class="">
        ...
        @endif
        <div>
            <div class="flex p-4 overflow-auto h-36 gap-x-4" style="width: 1200px;">

                <div class="flex items-center w-full h-full gap-x-1">
                    @foreach ($specialties as $specialty)
                        <button class="flex flex-col items-center justify-center w-full h-full p-6 text-center bg-white">
                            <ion-icon class="text-primary" name="flask-outline"></ion-icon>
                            <p class="text-xs font-medium text-gray-700">{{ $specialty->name }}</p>
                        ...
                        <figure class="relative flex flex-col-reverse p-4 bg-white rounded-lg w-80">
                            <blockquote class="w-full mt-2 text-slate-700 ">
                                ...
                                <div class="flex items-center w-full mt-4 gap-x-10">
                                    ...
                                    <!-- Modal toggle -->
                                    <button data-modal-target="crud-modal-{{ $doctor->id }}"
                                    ...
                                    <div id="crud-modal-{{ $doctor->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative w-full max-w-md max-h-full p-4">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <!-- Modal body -->
                                                <form id="form-{{ $doctor->id }}" class="p-4 md:p-5" method="POST"
                                                    action="{{ route('requestAppointment', ['doctorId' => $doctor->id]) }}">
                                                    @csrf
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                                        <div class="col-span-2 sm:col-span-1">
                                                            ...
                                                            <input type="number" name="duration"
                                                                id="Appointmentduration-{{ $doctor->id }}"
                                                        ...
                                                        <div class="col-span-2 sm:col-span-1">
                                                            <label for="preferred_time_range"
                                                        ...
                                                        <div class="col-span-2">
                                                            <label for="appMessage"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Appointment
                                                                Message</label>
                                                            <textarea id="description_{{ $doctor->id }}" rows="4" name="appMessage"
                            ...
                            <figcaption class="flex items-center space-x-4">
                                <div class="flex flex-col items-center gap-y-2">
                                    <img src="{{ $doctor->image }}" alt=""
                                        class="flex-none object-cover rounded-full w-14 h-14" loading="lazy"
                                        decoding="async">
                                    <span
