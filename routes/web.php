...
Route::post('/doctor/{doctorId}/profile-photo', [DoctorSettings::class, 'updateProfilePhoto'])->name('doctorProfilePhoto');
Route::post('/doctor/{doctorId}/social-accounts', [DoctorSettings::class, 'updateSocialAccounts'])->name('doctorSocialAccounts');
Route::post('/doctor/{doctorId}/general-info', [DoctorSettings::class, 'updateGeneralInfo'])->name('doctorGeneralInfo');
Route::post('/doctor/{doctorId}/update-password', [DoctorSettings::class, 'updatePassword'])->name('doctorPasswordUpdate');
