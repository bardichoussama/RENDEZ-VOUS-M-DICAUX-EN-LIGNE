                    ...
                    <figure
                        ...
                        <blockquote class="w-full text-slate-700">
                            <div class="flex items-center w-full gap-x-2">
                                ...
                                <!-- Reject Form -->
                                <form  action="{{ route('rejectAppointments',['appId' => $req->appointment_id]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                                ...
                                                <form class="p-4 mx-4 md:p-5">
                                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                                        ...
                                                        <div class="col-span-2">
                                                            <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reason of reject</label>
                                                            <textarea id="description" name="rejectMessage" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type the reason of reject"></textarea>                    
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="text-white inline-flex items-center bg-rejectText hover:bg-Text focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
